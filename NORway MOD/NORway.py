#!/usr/bin/python
# *************************************************************************
#  NORway.py v0.7 (MOD 0.1 by littlebalup)
#
...
if __name__ == "__main__":
	print
	print "NORway.py v0.7 MOD 0.1 - Teensy++ 2.0 NOR flasher for PS3"
	print "Original by judges <judges@eEcho.com>. Modded by littlebalup"
	...
	if len(sys.argv) == 1:
		...
		print "           Use \"perfw\" instead of an adress to write only PerFirmware datas"
		print "           from the dump file to the NOR (adress 0x40000, length 0xE80000)." 
		print
		print "Examples:"
		...
		print "  %s COM1 write d:\myflash.bin perfw"%sys.argv[0]
